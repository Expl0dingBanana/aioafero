...
def test_features_equivalent_open_and_fallback():
    open_a = features.OpenFeature(
        open=True, function_class="toggle", function_instance="s1"
    )
    open_b = features.OpenFeature(
        open=True, function_class="toggle", function_instance="s1"
    )
    open_c = features.OpenFeature(
        open=False, function_class="toggle", function_instance="s1"
    )
