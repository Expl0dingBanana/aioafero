...
This walks through a minimal session: log in, connect to your Afero account,
...
the password is accepted; Afero emails a code and **you** must collect it from the
